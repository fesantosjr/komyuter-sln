...
{
    public class RTVehiclePositionsConfiguration : EntityTypeConfiguration<RTVehiclePositions>, IModelConfiguration
    {
        public RTVehiclePositionsConfiguration()
        {
            this.ToTable("rt_vehicle_positions");
