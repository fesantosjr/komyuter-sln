...
{
    public class NaviRTServiceAlertsConfiguration : EntityTypeConfiguration<NaviRTServiceAlerts>, IModelConfiguration
    {
        public NaviRTServiceAlertsConfiguration()
        {
            this.ToTable("navi_rt_service_alerts");
